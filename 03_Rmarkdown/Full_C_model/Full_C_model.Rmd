...
```{r model plantation, fig.cap="Conceptual model for plantation (red boxes and arrows represent C emission, green boxes represent C storage)", echo=FALSE, out.width = "80%"}
...
```{r model nat for, fig.cap="Conceptual model for logging in natural forests (red boxes and arrows represent C emission, green boxes represent C storage)", echo=FALSE, out.width = "80%"}
